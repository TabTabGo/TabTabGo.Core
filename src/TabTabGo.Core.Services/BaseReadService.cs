    ...
    where TEntity : class, IEntity
{
    ...
    /// </summary>
    protected virtual string[] IncludeProperties { get; } = new string[] { };
    /// <summary>
    /// Properties need to be included when return detail content for entity
    /// </summary>
    protected virtual string[] DetailsProperties { get => IncludeProperties; }
    ...
    public BaseReadService(IGenericReadRepository<TEntity, TKey> repository, ILogger<BaseService<TEntity, TKey>> logger)
    {
